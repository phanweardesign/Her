...
function saveBooks(books) {
    ...
    save(HER_STORAGE_KEYS.BOOKS, safeBooks);

    // Keep MongoDB synchronized for logged-in users while retaining the
    // immediate local save that the rest of Her already expects.
    if (typeof HerCloudBooks !== "undefined") {
        HerCloudBooks.scheduleUpload(safeBooks);
    }
}
